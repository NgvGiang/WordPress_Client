...
public class CommentActivity extends AppCompatActivity {
    ...
    private void updateCommentAtPosition(int position, String newStatus, String changeFrom, String fragment) {
