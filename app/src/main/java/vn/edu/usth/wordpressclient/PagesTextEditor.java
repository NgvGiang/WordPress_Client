    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        contentViewModel.getSuccessLiveData().observe(this, success -> {
            ...
            if (success) {
                ...
                Snackbar.make(findViewById(android.R.id.content), "Page created successfully", 2500).show();
                new Handler(Looper.getMainLooper()).postDelayed(this::finish, 2500);
            }else {
                //occur network problem ?
                Snackbar.make(findViewById(android.R.id.content), "Failed to create page, please try again", Snackbar.LENGTH_SHORT).show();
            }
        });
